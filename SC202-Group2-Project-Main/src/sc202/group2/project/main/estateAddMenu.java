...
public class estateAddMenu {
    ...
    public void estateAddMain() {
        ...
        labelN = new JLabel("Menu Agregar nueva Finca");
        labelS = new JLabel("");
        LBestateName = new JLabel("Nombre"); 
        LBestateName.setPreferredSize(new Dimension(180,19));
        LBestateLocation = new JLabel("Ubicacion");
        LBestateLocation.setPreferredSize(new Dimension(180,19));
        LBestateManagerName = new JLabel("Nombre del Administrador");
        LBestateManagerName.setPreferredSize(new Dimension(200,19));
        LBestateManagerId = new JLabel("ID del Administrador");
        LBestateManagerId.setPreferredSize(new Dimension(180,19));
        LBestateManagerPhone = new JLabel("Tel del Administrador");
        LBestateManagerPhone.setPreferredSize(new Dimension(180,19));
        LBestateNumberPaddocks = new JLabel("Cant de Potreros");
        LBestateNumberPaddocks.setPreferredSize(new Dimension(180,19));
        LBestateSize = new JLabel("Tamano");
        LBestateSize.setPreferredSize(new Dimension(180,19));
        LBestateTotalCattle = new JLabel("Cant de Ganado");
